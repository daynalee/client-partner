...
export const EXPERIMENT_PLANS: ExperimentPlan[] = [
  ...
  },
  {
    ...
    decision: {
      ifWin: 'Roll fresh creative to 100%, and institutionalize a 4 to 6 week refresh cadence with a rolling production pipeline.',
  ...
  },
  {
    ...
    duration: '6 weeks',
    decision: {
      ifWin: 'Roll the +30% budget level out nationally and schedule the next ceiling test at +30% again, and scale until marginal return says stop.',
  ...
  },
  {
    ...
    hypothesis: 'Activating seasonal creative 8 to 10 weeks before the purchase peak captures early planners at low CPMs and compounds into cheaper, higher-intent conversions during the peak.',
    setup: [
      'Two-phase flight: Phase 1 (weeks 1 to 5) consideration objective with seasonal inspiration creative (video / Idea-style formats) to build engagement pools.',
      'Phase 2 (weeks 6 to 10) conversion objective retargeting Phase-1 engagers plus lookalikes, with shopping formats.',
      'Control: a matched audience segment excluded from Phase 1, entering only at Phase 2, which isolates the value of early activation.',
    ],
